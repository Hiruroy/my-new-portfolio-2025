(function ($) {
  ...
  scrollRotate.forEach((scrollRotate) => {
    gsap.to(scrollRotate, {
      scrollTrigger: { trigger: scrollRotate, scrub: 2 },
      rotation: 720,
    });
  });
  ...
  scrollMoveRight.forEach((scrollMoveRight) => {
    gsap.to(scrollMoveRight, {
      x: 500,
      duration: 1.5,
      scrollTrigger: { trigger: scrollMoveRight, start: "top 30%", scrub: 2 },
    });
  });
  ...
  scrollMoveLeft.forEach((scrollMoveLeft) => {
    gsap.to(scrollMoveLeft, {
      x: -500,
      duration: 1.5,
      scrollTrigger: { trigger: scrollMoveLeft, start: "top 30%", scrub: 2 },
    });
  });
  ...
  scrollMoveRight2.forEach((scrollMoveRight2) => {
    gsap.to(scrollMoveRight2, {
      x: 800,
      duration: 1.5,
      scrollTrigger: { trigger: scrollMoveRight2, start: "top 80%", scrub: 2 },
    });
  });
  ...
  scrollMoveLeft2.forEach((scrollMoveLeft2) => {
    gsap.to(scrollMoveLeft2, {
      x: -400,
      duration: 1.5,
      scrollTrigger: { trigger: scrollMoveLeft2, start: "top 100%", scrub: 2 },
    });
  });
  ...
  scrollMoveUp.forEach((scrollMoveUp) => {
    gsap.to(scrollMoveUp, {
      y: -400,
      duration: 1.5,
      scrollTrigger: { trigger: scrollMoveUp, start: "top 20%", scrub: 2 },
    });
  });
  ...
  growUp.forEach((growUp) => {
    gsap.fromTo(
      ...
      { autoAlpha: 0.5, scale: 0.7 },
      {
        ...
        duration: 2,
        scale: 1,
        scrollTrigger: { trigger: growUp, start: "top 90%" },
        stagger: 0.2,
      }
    );
  });
  ...
  scrollZoomIn.forEach((scrollZoomIn) => {
    gsap.to(scrollZoomIn, {
      scrollTrigger: { trigger: scrollZoomIn, start: "top 10%", scrub: 2 },
      scale: 1.2,
    });
  });
  ...
  scrollZoomIn2.forEach((scrollZoomIn2) => {
    gsap.to(scrollZoomIn2, {
      scrollTrigger: { trigger: scrollZoomIn2, start: "top 90%", scrub: 2 },
      scale: 1,
    });
  });
  ...
  scrollZoomOut.forEach((scrollZoomOut) => {
    gsap.to(scrollZoomOut, {
      scrollTrigger: { trigger: scrollZoomOut, start: "top 5%", scrub: 2 },
      scale: 0.5,
    });
  });
  ...
  revealContainers.forEach((revealContainers) => {
    ...
    tl4.from(revealContainers, 1.5, { xPercent: -100, ease: Power2.out });
    tl4.from(image, 1.5, {
      xPercent: 100,
      scale: 1.3,
      delay: -1.5,
  ...
  fadeInUp.forEach((fadeInUp) => {
    gsap.fromTo(
      ...
      { opacity: 1, duration: 1.5, scale: 1, y: 0 }
    );
  });
  ...
  scrollMoveUp2.forEach((scrollMoveUp2) => {
    gsap.to(scrollMoveUp2, {
      y: -100,
      duration: 1.5,
      scrollTrigger: { trigger: scrollMoveUp2, start: "top 70%", scrub: 2 },
    });
  });
  ...
  scrollMoveUp3.forEach((scrollMoveUp3) => {
    gsap.to(scrollMoveUp3, {
      y: -80,
      duration: 2,
      scrollTrigger: { trigger: scrollMoveUp3, start: "top 70%", scrub: 2 },
    });
  });
  ...
  btnTags.forEach((btnTags) => {
    gsap.from(btnTags, {
      ...
      ease: "elastic",
      force3D: !0,
      scrollTrigger: { trigger: btnTags, start: "top 80%" },
    });
  });
  ...
  if (imageParallax.length > 0) {
    $(".parallax-image").each(function () {
      ...
      let tl_aipZoomIn = gsap.timeline({
        scrollTrigger: { trigger: $aipWrap, start: "top 99%" },
      });
  ...
  imageHoverShow.forEach((target) => {
    ...
    tlImageShow
      ...
      .pause();
    target.anim = tlImageShow.play().reversed(!0);
  ...
  if (imageZoomIn.length > 0) {
    gsap.from(imageZoomIn, 2, { scale: 0, ease: "power3.inOut", delay: 0 });
  }
  ...
  if (!isMobile) {
    ...
    imageMarkScroll.forEach((imageMarkScroll) => {
      gsap.to(imageMarkScroll, {
        ...
        ease: "power3.inOut",
        duration: 1,
        scrollTrigger: { trigger: imageMarkScroll, start: "top 90%" },
      });
    });
  } else {
